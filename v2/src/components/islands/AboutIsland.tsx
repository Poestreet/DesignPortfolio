              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "24px", color: "#fafafa", marginBottom: "24px" }}>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0 }}>
                    ...
                    >
                      I have written here
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fafafa" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{ width: "16px", height: "16px", flexShrink: 0 }}>
                        <path d="M15 3h6v6"/>
                        <path d="M10 14 21 3"/>
