...
function RightCol() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start min-w-px relative" data-name="RightCol">
...
function Frontguys() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 text-[#fafafa] whitespace-nowrap" data-name="frontguys">
      <p className="font-['Fraunces:Bold_Italic',sans-serif] font-bold italic leading-[normal] relative shrink-0 text-[18px]" style={{ fontVariationSettings: "'SOFT' 0, 'WONK' 1" }}>
        2023 - 2025 .
      </p>
      <p className="font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[0] relative shrink-0 text-[0px]">
...
function Connect() {
  return (
    <div className="content-stretch flex gap-[4px] items-center leading-[normal] relative shrink-0 text-[#fafafa] text-[18px] whitespace-nowrap" data-name="connect">
      <p className="font-['Fraunces:Bold_Italic',sans-serif] font-bold italic relative shrink-0" style={{ fontVariationSettings: "'SOFT' 0, 'WONK' 1" }}>
        2021 - 2023 .
      </p>
      <p className="font-['Outfit:Medium',sans-serif] font-medium relative shrink-0">SNCF Connect / Senior Product Designer</p>
    </div>
  );
}
...
function TagsSection() {
  return (
    <div className="content-stretch flex gap-[8px] items-start py-[12px] relative shrink-0 w-full" data-name="tagsSection">
      <Tag />
      <Tag1 />
      <Tag2 />
      <Tag3 />
